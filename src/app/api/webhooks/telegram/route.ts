...
🆔 Ваш Telegram ID: \`${telegramId}\``;
      ...
      // Если не привязан - показываем ID и запрашиваем название организации
      const welcomeMessage = `👋 Добро пожаловать!

🆔 Ваш Telegram ID: \`${telegramId}\`

Сообщите этот ID администратору для привязки к объекту.

Или введите название вашей организации для поиска:`;
